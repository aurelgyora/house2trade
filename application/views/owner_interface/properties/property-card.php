			...
			<div class="span9">
				<div class="navbar">
					<div class="navbar-inner">
						<?=anchor('homeowner/properties/information/'.$this->session->userdata('property_id'),'Back to property detail','class="btn btn-link"');?>
					</div>
				</div>
				<div id="div-property-information" class="div-manage-property">
				<?php $this->load->view('owner_interface/forms/edit-properties');?>
