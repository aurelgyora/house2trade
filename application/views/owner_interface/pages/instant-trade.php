				...
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading">
							<a href="<?=site_url('homeowner/'.$this->uri->segment(2).'/information/'.$levels['level1']['id']);?>">
		...
		<?php if(!empty($levels['level2'])):?>
				...
				<?php for($i=0;$i<count($levels['level2']);$i++):?>
					<div class="media cycle-clocks-elements">
						...
						<div class="media-body">
							<h4 class="media-heading">
								<a href="<?=site_url('homeowner/'.$this->uri->segment(2).'/information/'.$levels['level2'][$i]['id']);?>">
			...
			<?php if(!empty($levels['level3'])):?>
				...
				<?php for($i=0;$i<count($levels['level3']);$i++):?>
					<div class="media cycle-clocks-elements">
						...
						<div class="media-body">
							<h4 class="media-heading">
								<a href="<?=site_url('homeowner/'.$this->uri->segment(2).'/information/'.$levels['level3'][$i]['id']);?>">
			...
			<?php if(!empty($levels['level4'])):?>
				...
				<?php for($i=0;$i<count($levels['level4']);$i++):?>
					<div class="media cycle-clocks-elements">
						...
						<div class="media-body">
							<h4 class="media-heading">
								<a href="<?=site_url('homeowner/'.$this->uri->segment(2).'/information/'.$levels['level4'][$i]['id']);?>">
			...
			<?php if(!empty($levels['level5'])):?>
				...
				<?php for($i=0;$i<count($levels['level5']);$i++):?>
					<div class="media cycle-clocks-elements">
						...
						<div class="media-body">
							<h4 class="media-heading">
								<a href="<?=site_url('homeowner/'.$this->uri->segment(2).'/information/'.$levels['level5'][$i]['id']);?>">
			...
			<?php if(!empty($levels['level6'])):?>
				...
				<?php for($i=0;$i<count($levels['level6']);$i++):?>
					<div class="media cycle-clocks-elements">
						...
						<div class="media-body">
							<h4 class="media-heading">
								<a href="<?=site_url('homeowner/'.$this->uri->segment(2).'/information/'.$levels['level6'][$i]['id']);?>">
